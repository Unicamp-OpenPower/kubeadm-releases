...
html = str(
    requests.get(
        'https://oplab9.parqtec.unicamp.br/pub/ppc64el/kubeadm/latest'
    ).content)
index = html.rfind('kubeadm-')
...
html = str(
    requests.get(
        'https://oplab9.parqtec.unicamp.br/pub/ppc64el/kubeadm'
    ).content)
index = html.find('kubeadm-')
